...
<div class="flex min-h-full flex-1 flex-col" onpaste={onPaste}>
	<textarea
		...
		tabindex="0"
		inputmode="text"
		class="scrollbar-custom max-h-[4lh] w-full resize-none overflow-y-auto overflow-x-hidden border-0 bg-transparent px-2.5 py-2.5 outline-none focus:ring-0 focus-visible:ring-0 sm:px-3 placeholder:text-[#306FC7]"
