			...
			>
				...
				{:else}
					...
					>
						...
						{:else}
							<button
								class="btn absolute bottom-2 right-2 size-7 self-end rounded-full bg-[#306FC7] text-white shadow transition-none enabled:hover:bg-[#306FC7]/80 disabled:text-gray-400/50 disabled:opacity-60 dark:bg-gray-900 dark:text-white dark:hover:enabled:bg-black dark:disabled:text-gray-600/50"
